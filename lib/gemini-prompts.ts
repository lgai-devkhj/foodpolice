...
function getIntegratedRatioEstimationCore(): string {
  return (
    ...
    '- keyInsights는 최대 5개이며 가공·영양·NOVA 등 종합 포인트만 쓴다.\n' +
...
export function getSingleProductJsonSchemaExample(): string {
  return (
    '{"productName":"","companyName":"","rawMaterials":"","novaGroup":4,"novaSubgroup":"","judgmentReason":"","concernIngredients":[{"name":"","explanation":"","minPercent":null,"maxPercent":null}],"estimatedIngredients":[],"keyInsights":[],"analysisConfidence":"medium","labelExplicitPercentages":[],"briefDescription":"","koreanReclassificationNote":"","consumptionAdvice":"","foodCategory":"","nutrition":null}'
  );
}
...
export function getIntegratedRatioEstimationEngineBlock(): string {
  return (
    ...
    '- concernIngredients만 사용하고 별도의 전체 미량 성분 목록은 만들지 않는다.\n' +
    '- estimatedIngredients는 항상 []이다.\n' +
    '- keyInsights, analysisConfidence, labelExplicitPercentages, concernIngredients.minPercent/maxPercent는 위 공통 규칙을 따른다.\n'
  );
}

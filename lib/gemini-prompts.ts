...
function getFoodPoliceFinalCriteriaBlock(mode: PromptMode = 'standard'): string {
  if (mode === 'fast') {
    return joinLines(
      ...
      '- 4A(재료 기반 초가공): 가공은 됐지만 원재료 정체성이 비교적 남아 있고 기능성 재구성 강도가 약한 편.',
      '- 4B(기능 중심 초가공): 전해질·제로·저당·고단백처럼 특정 기능 목적이 제품 중심이고 기능성 첨가 구조가 두드러짐.',
      '- 4C(고도 재구성 초가공): 복합 첨가 구조가 중심이고 강한 맛·기호성 설계가 두드러져 원재료 정체성이 희박한 편.',
      '- 예시 감각: 토레타·일부 요거트는 4A 쪽, 포카리스웨트·제로콜라·단백질음료는 4B 쪽, 강한 조미 과자·캔디류·일부 컵라면은 4C 쪽.'
    );
  }
  ...
  return joinLines(
    ...
    '- 4A(재료 기반 초가공): 가공은 됐지만 음식 형태와 원재료 정체성이 비교적 남아 있고 기능성 재구성 강도가 약한 편이에요.',
    '- 4B(기능 중심 초가공): 전해질·제로·저당·고단백처럼 특정 기능 목적이 제품 중심이고 기능성 첨가 구조가 눈에 띄는 편이에요.',
    '- 4C(고도 재구성 초가공): 복합 첨가 구조가 중심이고 강한 맛·기호성 설계가 두드러져 원재료 정체성이 희박한 편이에요.',
    '- 예시 감각: 토레타·일부 요거트는 4A 쪽, 포카리스웨트·제로콜라·단백질 음료는 4B 쪽, 강한 조미 과자·캔디류·일부 컵라면은 4C 쪽이에요.',
    '',
    '[중요]',
